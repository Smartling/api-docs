...
try {
    const myFunction = async (sourceFilePath, destinationFilePath) => {
    ...
    myFunction("./spec/translation_quality/dictionaries.yaml", "./spec/translation_quality/dictionaries_result.yaml");
    myFunction("./spec/translation_quality/profiles.yaml", "./spec/translation_quality/profiles_result.yaml");
    myFunction("./spec/translation_quality/checks/accounts.yaml", "./spec/translation_quality/checks/accounts_result.yaml");
    myFunction("./spec/translation_quality/check_type_severity_level.yaml", "./spec/translation_quality/check_type_severity_level_result.yaml");
    myFunction("./spec/translation_quality/account_settings.yaml", "./spec/translation_quality/account_settings_result.yaml");
    myFunction("./spec/translation_quality/tqc_check.yaml", "./spec/translation_quality/tqc_check_result.yaml");
} catch (e) {
    console.log(e);
}
